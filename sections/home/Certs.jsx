		...
		<section className="certs section section-dark" id="whitepaper">
			<div className="container">
				<div className="row g-5">
					<FadeIn className="col-md-6 d-flex justify-content-center  justify-content-md-start">
					...
					<FadeIn delay={0.5} className="col-md-6 d-flex justify-content-center  justify-content-md-start">
						<div className="cert-item d-md-block d-lg-flex g-0 align-items-center">
